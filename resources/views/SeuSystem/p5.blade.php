            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section-title text-center pb-10">
                        <h3 class="title mt-5">Gestão Pública</h3>
                            <p class="text">A SeuSystem, desenvolve atividades para elaboração do Planejamento 
                                Estratégico, treinamentos acerca de matéria que apresente natureza constitucional, 
                                jurídica, legal, regimental, financeira ou orçamentária.</p>

                            <p class="text">O Planejamento da Gestão no que tange a adequação à novas lei e/ou 
                                adequação de sistemáticas aplicadas ao aprimoramento e funcionamento nas 
                                normas vigentes .</p>
                    </div> 
                </div>
            </div> 
