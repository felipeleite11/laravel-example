            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section-title text-center pb-10">
                        <h3 class="title mt-5">Gestão Ambiental</h3>
                            <p class="text">Licenciamento Ambiental, estudo e elaboração de Laudo Hidrogeológico, 
                                Outorga de Recursos Hídricos, análise de água, estudo geológico, alocação de poços, 
                                CAR, cadastramento multifinalitário, plano de aproveitamento econômico – PAE, 
                                EIA, RIMA, EIV, Geoprocessamento, Mapas Geológico, topográficos morfológicos e de 
                                solo.</p>
                    </div> 
                </div>
            </div> 
