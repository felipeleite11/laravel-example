            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="section-title text-center pb-10">
                        <h3 class="title mt-5">Captação de Recursos</h3>
                        <p class="text">Implementar ações que permitam acesso a recursos financeiros públicos e 
                            privados para viabilizar projetos, programas e negócios inovadores apresentadas 
                            pelos órgãos ou entidades da administração pública direta ou indireta, de qualquer 
                            esfera do governo e/ou uma empresa.</p>
                    </div> 
                </div>
            </div> 
        </div> <!-- container -->
